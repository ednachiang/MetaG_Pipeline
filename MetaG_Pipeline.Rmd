...
*`bowtie2-build`
  + Calls upon command
*`-seed #`
  + Sets seed so that your resutls will be reproducible
...
* `--seed #`
  + Sets seed so your results are reproducible
...
Use [prodigal](https://github.com/hyattpd/Prodigal) to predict open reading frames. The guide here to prodigal is not comprehensive, so please consult the [prodigal website](https://github.com/hyattpd/Prodigal) for information on additional parameters.  
